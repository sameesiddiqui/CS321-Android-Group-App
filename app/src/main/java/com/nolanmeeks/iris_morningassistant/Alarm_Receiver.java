...
public class Alarm_Receiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Integer get_your_whale_choice = intent.getExtras().getInt("choice");

        Log.e("Pick Alarm sound ", get_your_whale_choice.toString());
        ...
        service_intent.putExtra("choice", get_your_whale_choice);
